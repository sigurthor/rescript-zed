...
;------------------
(module_binding
  definition: (_) @class.inside) @class.around
...
;------
(call_expression
  arguments: (_) @call.inside) @call.around

; Assignments
;------------
(let_binding
  body: (_) @assignment.inside) @assignment.around

; Conditionals
;-------------
(switch_match
  body: (sequence_expression) @conditional.inside) @conditional.around
